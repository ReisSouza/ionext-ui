var T=Object.defineProperty;var l=(t,a)=>T(t,"name",{value:a,configurable:!0});import{j as E,l as L,d as j,v as y,u as O,h as I}from"./iframe-8779e69d.js";var S="backgrounds",z;function P(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))}l(P,"_taggedTemplateLiteral$1");var g=E.document,R=E.window,$=l(function(){var a=R.matchMedia("(prefers-reduced-motion: reduce)");return a.matches},"isReduceMotionEnabled"),H=l(function(a){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:[],r=arguments.length>2?arguments[2]:void 0;if(a==="transparent")return"transparent";if(e.find(function(o){return o.value===a}))return a;var n=e.find(function(o){return o.name===r});if(n)return n.value;if(r){var d=e.map(function(o){return o.name}).join(", ");L.warn(j(z||(z=P([`
    ...
    `)},[i,p]);return O(function(){var f=e.viewMode==="docs"?"addon-backgrounds-docs-".concat(e.id):"addon-backgrounds-color";if(!s){_(f);return}D(f,v,e.viewMode==="docs"?e.id:null)},[s,v,e]),a()},"withBackground"),A;function K(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))}l(K,"_taggedTemplateLiteral");var Y=I(function(){},j(A||(A=K([`
    Backgrounds Addon: The cell size parameter has been changed.

    - parameters.grid.cellSize should now be parameters.backgrounds.grid.cellSize
    See https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#deprecated-grid-parameter
  `])))),U=l(function(a,e){var r,n,d,o,u=e.globals,i=e.parameters,s=i[S].grid,p=((r=u[S])===null||r===void 0?void 0:r.grid)===!0&&s.disable!==!0,v=s.cellAmount,f=s.cellSize,m=s.opacity,B=e.viewMode==="docs",c;(n=i.grid)!==null&&n!==void 0&&n.cellSize?(c=i.grid.cellSize,Y()):c=f;var x=i.layout===void 0||i.layout==="padded",M=x?16:0,b=(d=s.offsetX)!==null&&d!==void 0?d:B?20:M,k=(o=s.offsetY)!==null&&o!==void 0?o:B?20:M,w=y(function(){var h=e.viewMode==="docs"?"#anchor--".concat(e.id," .docs-story"):".sb-show-main",C=["".concat(c*v,"px ").concat(c*v,"px"),"".concat(c*v,"px ").concat(c*v,"px"),"".concat(c,"px ").concat(c,"px"),"".concat(c,"px ").concat(c,"px")].join(", ");return`
      `.concat(h,` {
...
//# sourceMappingURL=preview-f7543199.js.map
